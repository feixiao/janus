...
struct gengetopt_args_info
{
  ...
  int rfc_4588_flag;	/**< @brief Whether to enable RFC4588 retransmissions support or not (default=off).  */
  const char *rfc_4588_help; /**< @brief Whether to enable RFC4588 retransmissions support or not help description.  */
  int max_nack_queue_arg;	/**< @brief Maximum size of the NACK queue (in ms) per user for retransmissions.  */
  char * max_nack_queue_orig;	/**< @brief Maximum size of the NACK queue (in ms) per user for retransmissions original value given at command line.  */
  const char *max_nack_queue_help; /**< @brief Maximum size of the NACK queue (in ms) per user for retransmissions help description.  */
  int no_media_timer_arg;	/**< @brief Time (in s) that should pass with no media (audio or video) being received before Janus notifies you about this.  */
  char * no_media_timer_orig;	/**< @brief Time (in s) that should pass with no media (audio or video) being received before Janus notifies you about this original value given at command line.  */
  const char *no_media_timer_help; /**< @brief Time (in s) that should pass with no media (audio or video) being received before Janus notifies you about this help description.  */
  ...
  unsigned int rfc_4588_given ;	/**< @brief Whether rfc-4588 was given.  */
